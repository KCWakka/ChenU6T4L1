public class TriangleCollection {
    ...
    public TriangleCollection(int numTriangles, int startX, int startY) {
        ...
        for (int i = 0; i < collection.length; i++) {
            Point temp = new Point(-startX, 0);
            Point temp1 = new Point(0, startY);
            Point temp2 = new Point(startX - i, 0);
            collection[i] = new Triangle(temp, temp1, temp2);
        }
    }
